...
import com.jimingxin.newsdemo.weather.Utils.WeatherJsonUtils;
...
public class WeatherModelImpl implements WeatherModel {
    ...
    public void loadLocation(Context context, final LoadLocationListener listener){
        ...
        String url = getLoactionURL(latitude,longitude);
        OkHttpUtils.ResultCallback<String> callback = new OkHttpUtils.ResultCallback<String>() {
            @Override
            public void onSuccess(String response) {
     ...
     * @return
     */
    private String getLoactionURL(double latitude, double longitude){
